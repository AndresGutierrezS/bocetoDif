                ...
                <div class="form-section">
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <input type="text" id="nombre" name="nombre" class="form-control" value="{{ old('nombre', $menor->nombre) }}">
                            @error('nombre')
                                <p class="error">
                                    {{ $message }}
                                </p>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="apellidoPaterno" name="apellido_paterno" class="form-control" value="{{ old('apellido_paterno', $menor->apellido_paterno) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="apellidoMaterno" name="apellido_materno" class="form-control" value="{{ old('apellido_materno', $menor->apellido_materno) }} ">
                        </div>
                        
                        <div class="form-group">
                            <label for="curp" class="required">CURP</label>
                            <input type="text" id="curp" name="curp" class="form-control" value="{{ old('curp', $menor->curp) }} ">
                            @error('curp')
                                <p class="error">
                                    {{ $message }}
                                </p>
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" id="fechaNacimiento" name="fecha_nacimiento" class="form-control" value="{{ old('fecha_nacimiento', $menor->fecha_nacimiento) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="edad" name="edad" class="form-control" value="{{ old('edad', $menor->edad) }}">
                            @error('edad')
                                <p class="error">
                                    {{ $message }}
                                </p>
                        ...
                        <div class="form-group">
                            ...
                            <select id="sexo" name="sexo" class="form-control">
                                <option value="" disabled {{ old('sexo', $menor->sexo) ? '' : 'selected' }}>Seleccionar...</option>
                                <option value="Femenino" {{ old('sexo', $menor->sexo) == 'Femenino' ? 'selected' : '' }}>Femenino</option>
                                <option value="Masculino" {{ old('sexo', $menor->sexo) == 'Masculino' ? 'selected' : '' }}>Masculino</option>
                                <option value="Otro" {{ old('sexo', $menor->sexo) == 'Otro' ? 'selected' : '' }}>Otro</option>
                            </select>
                            @error('sexo')
                                <p class="error">
                                    {{ $message }}
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="nacionalidad" name="nacionalidad" class="form-control" value="{{ old('nacionalidad', $menor->nacionalidad) }}">
                            @error('nacionalidad')
                                <p class="error">
                                    {{ $message }}
                                </p>
                ...
                <div class="form-section">
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <input type="date" id="fechaIngreso" name="fecha_ingreso" class="form-control" value="{{ old('fecha_ingreso', $menor->fecha_puesta) }}">
                            @error('fecha_ingreso')
                                <p class="error">
                                    {{ $message }}
                                </p>
                        ...
                        <div class="form-group">
                            ...
                            <select id="albergue" name="albergue" class="form-control">
                                <option value="" disabled {{ old('albergue', $menor->ubicacion_actual) ? '' : 'selected' }}>Seleccionar...</option>
                                <option value="Casa Hogar Esperanza" {{ old('albergue', $menor->ubicacion_actual) == 'Casa Hogar Esperanza' ? 'selected' : '' }}>Casa Hogar Esperanza</option>
                                <option value="Hogar Infantil San José" {{ old('albergue', $menor->ubicacion_actual) == 'Hogar Infantil San José' ? 'selected' : '' }}>Hogar Infantil San José</option>
                                <option value="Albergue Niños Felices" {{ old('albergue', $menor->ubicacion_actual) == 'Albergue Niños Felices' ? 'selected' : '' }}>Albergue Niños Felices</option>
                            </select>
                            @error('albergue')
                                <p class="error">
                                    {{ $message }}
